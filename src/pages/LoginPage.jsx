...
import loginBg from "../assets/Rumah Fantasi 1.svg";
    ...
    <div className="flex w-screen h-screen overflow-hidden bg-[#F5EEE9]">
      ...
      <div className="w-2/5 flex flex-col justify-center items-start px-24 gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-lg font-medium text-[#4A2E1E]">
        ...
        <div className="w-full flex flex-col gap-4 mt-4 max-w-md">
          ...
          <button className="self-start text-sm text-[#4A2E1E] hover:underline mt-1">
            Forgot Password
          </button>

          <button className="mt-2 bg-[#4A2E1E] text-white py-3 rounded-full font-bold text-lg shadow-md hover:scale-105 transition w-full">
            Login
          </button>

          <p className="text-sm text-[#4A2E1E] mt-2 text-center">
